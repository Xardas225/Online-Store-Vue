<template>
    <v-container>
        <div class="mb-4">
            <v-row>
                <v-col md="8" class="v-home-carousel" v-if="HOME_DATA.carousel">
                    <h4 class="text-h4 mb-4 text-left">Популярные товары</h4>
                    <vCarouselElement :carousel_items="HOME_DATA.carousel"></vCarouselElement>
                </v-col>
                <v-col 
                    class="v-home-promotion" 
                    md="4"
        ...
        >
            ...
            <v-row>
                <vCardCategoryElement
                    v-for="card_item in HOME_DATA.popular_categories"
                    :key="card_item.id"
                    :card_item="card_item"    
                ></vCardCategoryElement>
            </v-row> 
...
export default {
    ...
    methods: {
        ...mapActions([
            'GET_HOME_DATA_FROM_API'
        ])
    },
    mounted() {
        this.GET_HOME_DATA_FROM_API();
    }
}
</script>
